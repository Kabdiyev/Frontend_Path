...
const BusinessReport1 = () => {
    ...
    useEffect(() => {
        axios.get(`https://fastapi-production-fffa.up.railway.app/Gallup/${pdfId}/business_report1`, {
            headers: {
    ...
    const onRegenerateClick = () => {
        ...
        axios.get(`https://fastapi-production-fffa.up.railway.app/Gallup/${pdfId}/business_report1?regenerate=true`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
