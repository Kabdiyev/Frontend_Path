...
const Report4 = () => {
    ...
    useEffect(() => {
        axios.get(`https://fastapi-production-fffa.up.railway.app/Gallup/${pdfId}/report4`, {
            headers: {
    ...
    const onRegenerateClick = () => {
        ...
        axios.get(`https://fastapi-production-fffa.up.railway.app/Gallup/${pdfId}/report4?regenerate=true`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
